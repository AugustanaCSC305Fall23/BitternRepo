<<<<<<< HEAD:GymnasticsApp/src/main/java/edu/augustana/HomeScreenController.java
...
public class HomeScreenController {
    ...
    void exitApp(ActionEvent event) throws IOException {
        App.getFavoriteCards().fileWriter.close();
        Platform.exit();
...
>>>>>>> main:GymnasticsApp/src/main/java/edu/augustana/ui/HomeScreenController.java
